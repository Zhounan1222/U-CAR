...
parser.add_argument('--dataset', type=str, default='', help="iu-xray or mimic-cxr")
...
parser.add_argument('--model_name', default='', type=str, help="add_label/add_hoplayer")
...
parser.add_argument('--max_epochs', type=int, default=500, help='Stop training once this number of epochs is reached')
